...
value class Acceleration internal constructor(val value: Float) : Comparable<Acceleration> {
	...
	operator fun div(right: Acceleration) = this.value.toDouble() / right.value.toDouble()
	...
	companion object {
		fun raw(value: Float) = Acceleration(value)

		val MPS2 = Acceleration(1.0f)
	}
}
...
operator fun Duration.times(right: Acceleration) = right * this
