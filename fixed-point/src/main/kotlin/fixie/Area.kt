...
value class Area internal constructor(val value: Double) : Comparable<Area> {
	...
	fun toDouble(unit: AreaUnit) = when (unit) {
		AreaUnit.SQUARE_MILLIMETER -> value * 1000000.0
		AreaUnit.SQUARE_INCH -> value * 1550.0031000062002
		AreaUnit.SQUARE_METER -> value
		AreaUnit.HECTARE -> value * 1.0E-4
	}
	...
	operator fun times(right: Displacement) = Volume.CUBIC_METER * value * right.toDouble(DistanceUnit.METER)

	companion object {
		fun raw(value: Double) = Area(value)
