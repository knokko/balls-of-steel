...
internal class EntityClustering {
	...
	private fun determineKey(indexX: Int, indexY: Int, indexZ: Int) =
		indexX.toLong() + 1_000_000L * indexY.toLong() - 1_234_567L * indexZ
